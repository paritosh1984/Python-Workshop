...
\item We have understood how to make choices when we are presented with a dilemma of choosing between space requirements and execution time requirements.
\end{itemize}
\end{frame}
\end{document}
